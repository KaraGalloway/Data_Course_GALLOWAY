...
# The vector of nums defaulted to a dot plot with axis titles
# and the factor of nums defaulted to a bar graph without titles
...
iris_sub <- iris[seq(2,150,2),] # here's the code to get a list of the even numbers between 2 and 150
